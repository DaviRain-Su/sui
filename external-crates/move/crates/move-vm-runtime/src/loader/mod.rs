...
use move_binary_format::{
    ...
    file_format::{
        ...
        FieldHandleIndex, FieldInstantiationIndex, FunctionInstantiationIndex,
        SignatureIndex, SignatureToken, StructDefInstantiationIndex, StructDefinitionIndex,
        StructFieldInformation, TableIndex, TypeParameterIndex, VariantHandleIndex,
...
pub(crate) struct BinaryCache<K, V> {
    pub(crate) id_map: HashMap<K, usize>,
    pub(crate) binaries: Vec<Arc<V>>,
}
...
pub(crate) struct CacheCursor {
    pub(crate) last_datatype: usize,
    pub(crate) last_function: usize,
}
